...
class nsIWidget : public nsISupports {
 ...
 public:
  ...
  typedef mozilla::layers::APZCGuid APZCGuid;
  ...
  virtual void SetConfirmedTargetAPZC(
      uint64_t aInputBlockId, const nsTArray<APZCGuid>& aTargets) const = 0;
